...
screenshots/		Папка, куда автоматически сохраняются скриншоты кадров с обнаруженными телефонами. (создается автоматически)
uploads/		Папка для хранения загруженных видеофайлов. (создается автоматически)
